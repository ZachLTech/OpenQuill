...
<template>
    <form @submit.prevent="handleSignup" class="w-full flex flex-col justify-center items-center gap-4">
        ...
        <button type="submit" :disabled="loading" class=" w-full h-12 rounded bg-primary hover:bg-opacity-90 transition-all">
